...
while not event.is_set():
    ...
    if upecao > 90:
        pyautogui.press('i')
        time.sleep(1)
        hrana = pyautogui.locateCenterOnScreen('hrana.png', confidence=0.9)
        ...
        pyautogui.press('i')
        time.sleep(1)
        voda = pyautogui.locateCenterOnScreen('voda.png', confidence=0.7)
    ...
    if kod:
        img = ImageGrab.grab(bbox=(790, 170, 1150, 270))  # x, y, w, h
        img_np = np.array(img)
